<template>
  <div>
    ...
    <section>
      <p>
       System Performance UFAX แสดงโพสต์ ปลายทาง ผ่าน WordPress REST API
        แสดงมุมมอง รวม &amp; บทความของเว็บ ๆ เพื่อให้ ครอบคลุม CC ระบบ <a href="https://ufatop1.net/">MAIN UFATOP1.NET</a>.
      </p>
    </section>
